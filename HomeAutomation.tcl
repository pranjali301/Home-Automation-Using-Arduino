...
#  Apr 25, 2019 05:36:30 PM +0530  platform: Windows NT
set vTcl(timestamp) ""
...
foreach img {
        ...
        {{[file join D:/ {Algorithmic Electronics Projects} {Python Home Automation} mic.png]} {file not found!} user {}}
...
proc vTclWindow.top42 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        ...
        -highlightcolor {#63131e} 
    wm focusmodel $top passive
    wm geometry $top 1300x650+20+10
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    frame $top.fra43 \
        ...
        -highlightbackground {#d9d9d9} -highlightcolor black -width 895 
    ...
    label $site_3_0.lab50 \
        ...
        -foreground {#000000} -highlightbackground {#d9d9d9} \
        -highlightcolor black -text {Bed Room} 
    ...
    vTcl:DefineAlias "$site_3_0.lab68" "Label2_3" vTcl:WidgetProc "Toplevel1" 1
    label $site_3_0.lab71 \
        ...
        -image [vTcl:image:get_image [file join D:/ {Algorithmic Electronics Projects} {Python Home Automation} mic.png]] \
        -text {Voice Control} 
    ...
    button $top.but43 \
        ...
        -background {#d9d9d9} -disabledforeground {#a3a3a3} \
        -font {-family {Segoe UI} -size 14 -weight bold} \
        -foreground {#000000} -highlightbackground {#d83a64} \
        -highlightcolor {#000000} -pady 0 -text Quit 
    vTcl:DefineAlias "$top.but43" "quitbutton" vTcl:WidgetProc "Toplevel1" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.fra43 \
    ...
    place $top.fra62 \
        ...
        -relheight 0 -anchor nw -bordermode ignore 
    place $top.but43 \
        -in $top -x 590 -y 590 -width 117 -relwidth 0 -height 44 -relheight 0 \
        -anchor nw -bordermode ignore 
